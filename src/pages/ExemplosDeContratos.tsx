...
const ExemplosDeContratos = () => {
  ...
  const contractExamples = {
    ...
    "mandato": {
      outorgante_nome: "Eduardo Santana Ribeiro",
      outorgante_cpf: "100.200.300-40",
      outorgante_rg: "10.020.030-4",
      outorgante_estado_civil: "casado",
      outorgante_profissao: "empresário",
      outorgante_endereco: "Rua Voluntários da Pátria",
      outorgante_numero: "2500",
      outorgante_bairro: "Botafogo",
      outorgante_cidade: "Rio de Janeiro",
      outorgante_estado: "RJ",
      outorgante_cep: "22270-000",
      outorgante_email: "eduardo.ribeiro@email.com",
      outorgante_whatsapp: "(21) 99123-4567",
      outorgado_nome: "Dr. Rafael Costa Martins",
      outorgado_cpf: "200.300.400-50",
      outorgado_rg: "20.030.040-5",
      outorgado_estado_civil: "solteiro",
      outorgado_profissao: "advogado",
      outorgado_endereco: "Avenida Rio Branco",
      outorgado_numero: "120",
      outorgado_bairro: "Centro",
      outorgado_cidade: "Rio de Janeiro",
      outorgado_estado: "RJ",
      outorgado_cep: "20040-001",
      outorgado_email: "dr.rafael@email.com",
      outorgado_whatsapp: "(21) 98234-5678",
      tipo_mandato: "Específico",
      poderes_descricao: "Representar o MANDANTE perante órgãos públicos federais, estaduais e municipais, especialmente Receita Federal, Junta Comercial e Secretaria da Fazenda; assinar contratos e documentos em nome do MANDANTE; movimentar contas bancárias específicas da empresa; receber notificações e intimações; requerer certidões e documentos.",
      prazo_mandato: "24 meses",
      remuneracao: "Sim (Oneroso)",
      valor_remuneracao: "5.000,00",
      substabelecimento: "Sim",
      revogacao: "Pode revogar a qualquer momento",
      prestacao_contas: "Sim",
      finalidade_especifica: "Regularização fiscal e societária da empresa do MANDANTE junto aos órgãos competentes"
    },
    "alienacao-fiduciaria": {
      credor_fiduciario_nome: "Banco Financeiro S.A.",
      credor_fiduciario_documento: "55.666.777/0001-88",
      credor_fiduciario_rg: "",
      credor_fiduciario_endereco: "Avenida Brigadeiro Faria Lima",
      credor_fiduciario_numero: "3400",
      credor_fiduciario_bairro: "Itaim Bibi",
      credor_fiduciario_cidade: "São Paulo",
      credor_fiduciario_estado: "SP",
      credor_fiduciario_cep: "04538-132",
      credor_fiduciario_email: "credito@bancofinanceiro.com.br",
      credor_fiduciario_whatsapp: "(11) 4000-1000",
      devedor_fiduciante_nome: "Lucas Henrique Almeida",
      devedor_fiduciante_documento: "300.400.500-60",
      devedor_fiduciante_rg: "30.040.050-6",
      devedor_fiduciante_estado_civil: "casado",
      devedor_fiduciante_profissao: "engenheiro",
      devedor_fiduciante_endereco: "Rua dos Três Irmãos",
      devedor_fiduciante_numero: "1200",
      devedor_fiduciante_bairro: "Vila Progredior",
      devedor_fiduciante_cidade: "São Paulo",
      devedor_fiduciante_estado: "SP",
      devedor_fiduciante_cep: "05615-010",
      devedor_fiduciante_email: "lucas.almeida@email.com",
      devedor_fiduciante_whatsapp: "(11) 97123-4567",
      tipo_bem: "Veículo Automotor",
      bem_descricao: "Veículo automotor marca HONDA, modelo CIVIC TOURING, ano de fabricação 2023, ano modelo 2024, cor PRETA, gasolina/flex",
      veiculo_placa: "BRA-2J45",
      veiculo_chassi: "93HFC2660P5123456",
      veiculo_renavam: "12345678902",
      imovel_matricula: "",
      imovel_cartorio: "",
      valor_bem: "135.000,00",
      valor_financiado: "108.000,00",
      valor_entrada: "27.000,00",
      numero_parcelas: "60",
      valor_parcela: "2.450,00",
      taxa_juros: "1.49",
      vencimento_primeira_parcela: "15/03/2025",
      local_pagamento: "Débito automático em conta bancária",
      cet: "23.45",
      seguro_obrigatorio: "Sim",
      multa_inadimplencia: "2",
      mora_diaria: "0.033",
      vencimento_antecipado: "Sim",
      consolidacao_propriedade: "Busca e Apreensão (DL 911/69)"
    }
  };
  ...
  const examples = [
    ...
    },
    {
      ...
      description: "Autorização legal para representação com poderes específicos ou gerais.",
      contractId: "mandato",
      preview: "CONTRATO DE MANDATO\n\nOUTORGANTE: Eduardo Santana Ribeiro, brasileiro, casado, empresário...",
    },
    {
      title: "Contrato de Alienação Fiduciária",
      description: "Garantia de financiamento com transferência de propriedade resolúvel do bem.",
      contractId: "alienacao-fiduciaria",
      preview: "CONTRATO DE ALIENAÇÃO FIDUCIÁRIA EM GARANTIA\n\nCREDOR: Banco Financeiro S.A., CNPJ nº 55.666.777/0001-88...",
    }
  ];
